...
@app.get("/v0/players/",
         ...
         summary="Get players matching any given filters",
         description="Get a list of all players in SWC data according to input filters",
         response_description="List of NFL players",
...
def read_players(skip: int=Query(0, description="The number of items to skip at the beginning of the API call."),
    ...
    players = crud.get_players(db, skip=skip, limit=limit, minimum_last_changed_date=minimum_last_changed_date, last_name=last_name, first_name=first_name)
    return players
    
@app.get("/v0/performances/",
         response_model=list[schemas.Performance],
         summary="Get performances matching any given filters",
         description="Get a list of all performances in SWC data according to input filters",
         response_description="List of NFL performances",
         operation_id="v0_get_performances",
         tags=["scoring"])
def read_performances(skip: int=Query(0, description="The number of items to skip at the beginning of the API call."),
                                      limit: int=Query(100, description="The number of records to return after the skipped records."),
                                      minimum_last_changed_date: date=Query(None, description="The minimum date of change that you want to return records. Exclude any records changed before this."),
                                      db: Session=Depends(get_db)):
    performances = crud.get_performances(db, skip=skip, limit=limit, minimum_last_changed_date=minimum_last_changed_date)
    return performances
...
@app.get("/v0/leagues/{league_id}",
         ...
         description="If you have an SWC league ID of a player from another API call such as v0_get_leagues, you can call this API using the league ID",
...
@app.get("/v0/leagues/",
         ...
         summary="Get a list of all leagues in SWC data according to input filters",
         description="Get a list of all leagues in SWC data according to input filters",
         response_description="List of NFL leagues",
         operation_id="v0_get_leagues",
         tags=["membership"])
def read_leagues(skip: int=Query(0, description="The number of items to skip at the beginning of the API call."),
                                 limit: int=Query(100, description="The number of records to return after the skipped records."),
                                 minimum_last_changed_date: date=Query(None, description="The minimum date of change that you want to return records. Exclude any records changed before this."),
                                 league_name: str=Query(None, description="The name of the leagues to return."),
                                 db: Session=Depends(get_db)):
    leagues = crud.get_leagues(db, skip=skip, limit=limit, minimum_last_changed_date=minimum_last_changed_date, league_name=league_name)
    return leagues

@app.get("/v0/teams/",
         response_model=list[schemas.Team],
         summary="Get a list of all teams in SWC data according to input filters",
         description="Get a list of all teams in SWC data according to input filters",
         response_description="List of NFL teams",
         operation_id="v0_get_teams",
         tags=["membership"])
def read_teams(skip: int=Query(0, description="The number of items to skip at the beginning of the API call."),
                               limit: int=Query(100, description="The number of records to return after the skipped records."),
                               minimum_last_changed_date: date=Query(None, description="The minimum date of change that you want to return records. Exclude any records changed before this."),
                               team_name: str=Query(None, description="The name of the teams to return."),
                               league_id: int=Query(None, description="The ID of the league for the teams to return"),
                               db: Session=Depends(get_db)):
    teams = crud.get_teams(db, skip=skip, limit=limit, minimum_last_changed_date=minimum_last_changed_date, team_name=team_name, league_id=league_id)
    return teams

@app.get("/v0/counts/",
         response_model=schemas.Counts,
         summary="Get count summary statistics",
         description="Get the count of leagues, teams, and players",
         response_description="List of counts",
